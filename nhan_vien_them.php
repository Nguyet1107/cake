    ...
    <!-- Header Section End -->
     ...
     <section class="login spad">
        <div class="row">
            <div class="container">
                <div >
                    <p style="font-style: italic; font-weight: bold; font-family: Playfair Display; font-size: 20px; margin-top:50px; margin-left: 50px;">Thêm nhân viên: </p>
                </div>
                <div>
                    <form method="POST" action="./nhan_vien_them_thuc_hien.php" enctype="multipart/form-data">
                        <div class="row">
                            <div>
                                <p>
                                    Họ tên:<br>
                                    <input type="text" name="txtHoTen" style="width: 100%">
                                </p>
                            ...
                            <div style="margin-left: 50px;">
                                <p>
                                    Công việc: <br>
                                    <textarea name="txtCongViec" style="width: 150%;"></textarea>
                                </p>
                                <p>
                                    Facebook: <br>
                                    <input type="text" name="txtFb" style="width: 150%">
                                </p>
                                <p>
                                    Instagram:<br>
                                    <input type="text" name="txtIns" style="width: 150%">
                                </p>
