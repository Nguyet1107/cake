    ...
    <!-- Header Section End -->
     ...
     <section class="login spad">
        <div class="row">
            <div class="container">
                <div >
                    <p style="font-style: italic; font-weight: bold; font-family: Playfair Display; font-size: 20px; margin-top:50px; margin-left: 50px;">Thông tin nhân viên: </p>
                        <?php 
                            $ket_noi=mysqli_connect("localhost","root","","cua_hang_banh");
                    ...
                    <a href="nhan_vien_them.php"><button style="margin-left: 50px; color: #ffffff; background: #F08632;border: none; padding: 10px 15px;">Thêm nhân viên</button></a>
                </div>
                <div>
                    <table style="margin-left: 100px;margin-top: 20px">
                        ...
                        ;?>
                            <tr>
                                ...
                                <td><img src="img/team/<?php echo $row["hinh_anh"] ;?>" style="width: 100px; height: auto;"></td>
                                <td><?php echo $row["cong_viec"] ;?></td>
                                <td><?php echo $row["facebook"] ;?></td>
                                <td><?php echo $row["instagram"] ;?></td>
                                <td><a href="nhan_vien_sua.php?id=<?php echo $row["id_nhan_vien"] ;?>"><img src="img/edit.png" style="width: 32px; height: auto;"></a> </td>
                                <td><a href="nhan_vien_xoa.php?id=<?php echo $row["id_nhan_vien"] ;?>"><img src="img/delete.png" style="width: 32px; height: auto;"></a></td>
                            </tr>
                            <?php 
                            }
                            ;?>
